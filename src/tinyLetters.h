...
#ifndef MUEK_TGLBOARD_FORK_TINYLETTERS_H
#define MUEK_TGLBOARD_FORK_TINYLETTERS_H
...
static const uint8_t tinyE[] = {0b111, 0b101, 0b110,0b111, 3}; // hmm
...
static const String tinySpecialChars = "12l|";

static const uint8_t *tinyLetter[] = {tinyA, tinyB, tinyC, tinyD, tinyE, tinyF, tinyG, tinyH, tinyI, tinyJ, tinyK, tinyL, tinyM, tinyN, tinyO, tinyP, tinyQ, tinyR, tinyS, tinyT, tinyU,
                                      tinyV, tinyW, tinyX, tinyY, tinyZ,
                                      tinyA, tinyB, tinyC, tinyD, tinyE, tinyF, tinyG, tinyH, tinyI, tinyJ, tinyK, tinyL, tinyM, tinyN, tinyO, tinyP, tinyQ, tinyR, tinyS, tinyT, tinyU,
                                      tinyV, tinyW, tinyX, tinyY, tinyZ,
                                      tiny_, tiny0, tiny1, tiny2, tiny3, tiny4, tiny5, tiny6, tiny7, tiny8, tiny9,
                                      tinyRoundBracketO, tinyRoundBracketC, tinyDot, tinyComma, tinyQuestionMark, tinyExclamationMark, tinyUnderscore,
                                      tinyDash, tinyColon,tinySquareBracketO,tinySquareBracketC,tinySemiColon, tinyPlus, tinySlash, tinyBackSlash,

                                      tiny_1, tiny_2, tinyPipe, tinyPipe};

#endif //MUEK_TGLBOARD_FORK_TINYLETTERS_H
